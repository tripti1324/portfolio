...
import ImgForPF from '../assets/ImgForPF.png'
      ...
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between' >
            <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
               <h1 className='lg:text-7xl text-4xl font-bold lg:leading-snug'>Hi There, <br />I'm Tripti <span className='text-red-500'>Rani</span></h1>
               ...
               <button className='bg-black text-white px-3 py-2 w-max rounded-md'><a href="https://drive.google.com/file/d/1YSl7XlRf_lASeDdpbfhQ_KJDjz7RJRyl/view?usp=drivesdk" download target='_blank'>Download CV</a></button>
            </div>
            <div className='md:w-1/2 relative flex justify-center items-end'>
                 <img src={ImgForPF} alt="" className='lg:h-[90vh] h-96' />
